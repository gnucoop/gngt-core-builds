    ...
    var SyncService = /** @class */ (function () {
        ...
        function (tableName, object) {
            ...
            function (id) {
                ...
                /** @type {?} */
                var localDoc = { table_name: tableName, object_id: id, object: object };
                return rxjs.from(_this._database.post(localDoc)).pipe(operators.take(1), operators.exhaustMap((/**
                 * @param {?} doc
                 * @return {?}
                 */
                function (doc) { return _this._createLocalSyncEntry(__assign({ doc_id: doc.id }, localDoc)); })), operators.map((/**
                 * @param {?} _
                 * @return {?}
                 */
        ...
        function (syncEntry) {
            ...
            function (syncNumber) {
                 ...
                 * @return {?}
                 */
                function (_) { return _this._setLocalSyncNumber(syncNumber); })));
            })));
        };
        /**
         * @private
         ...
         * @return {?}
         */
        SyncService.prototype._processChanges = /**
         * @private
         * @param {?} syncEntries
         * @return {?}
         */
         ...
         * @return {?}
         */
        SyncService.prototype._processChange = /**
         * @private
         * @param {?} change
         * @return {?}
         */
