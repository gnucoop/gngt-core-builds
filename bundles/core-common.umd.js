(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.gngt = global.gngt || {}, global.gngt.core = global.gngt.core || {}, global.gngt.core.common = {}), global.ng.core, global.ng.forms));
     ...
     *
     */
    function getObjectProperty(value, prop) {
        if (prop == null) {
            return null;
        }
        if (!/\./.test(prop)) {
    ...
    var GetObjectProperty = /** @class */ (function () {
        ...
        GetObjectProperty.prototype.transform = function (value, prop) {
    ...
    ***************************************************************************** */
     ...
     *
     */
    function mergeQueryParams(win, loose) {
        var fields = loose.fields || win.fields ? __spreadArray(__spreadArray([], __read((loose.fields || []))), __read((win.fields || []))) : null;
        var joins = loose.joins || win.joins ? __spreadArray(__spreadArray([], __read((loose.joins || []))), __read((win.joins || []))) :
            null;
        var merged = Object.assign(Object.assign(Object.assign({}, loose), win), { selector: Object.assign(Object.assign({}, loose.selector), win.selector), sort: Object.assign(Object.assign({}, loose.sort), win.sort) });
        if (fields != null) {
